...
//                 >
//                   <TextArea
//                     placeholder="نظر خود را در مورد این ویدئو بنویسید..."
//                     rows={4}
//                     size="large"
//                   />
//                 </Form.Item>
...
//                     htmlType="submit"
//                     size="large"
//                     className="w-full bg-[#ce1a2a] hover:bg-red-700 border-none"
//                   >
//                     ثبت دیدگاه
//                   </Button>
//                 </Form.Item>
...
//               {video.comment > 0 ? (
//                 // اینجا می‌توانید نظرات واقعی را نمایش دهید
//                 <div className="text-center py-8 text-gray-500">
//                   <p>هنوز نظری برای این ویدئو ثبت نشده است</p>
